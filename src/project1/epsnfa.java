...
public class epsnfa{
	...
	int[] union(int s1,int t1,int s2,int t2)
	{
		...
		addEdge(s, epssymbol, s1);
		addEdge(s, epssymbol, s2);
		addEdge(t1, epssymbol, t);
		addEdge(t2, epssymbol, t);
	...
	int[] clo(int s1,int t1)
	{
		...
		addEdge(s, epssymbol, s1);
		addEdge(s, epssymbol, t);
		addEdge(t1, epssymbol, s1);
		addEdge(t1, epssymbol, s);
	...
	public static void main(String args[]) {
		System.out.println(new epsnfa().Start("data/sampleRE.in"));
	}
}
